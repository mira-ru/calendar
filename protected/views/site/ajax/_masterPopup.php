				...
				<div class="col-8">
					...
					resetDisqus = function(){
						DISQUS.reset({
							reload: true,
							config: function () {
								this.page.identifier = "user-<?php echo $item->id; ?>";
								this.page.url = "<?php echo Yii::app()->homeUrl.'/#!user-'.$item->id; ?>";
							}
						});
					};
					if (typeof DISQUS === 'undefined') {
						...
						var disqus_identifier = 'user-<?php echo $item->id; ?>';
						var disqus_url = "<?php echo Yii::app()->homeUrl.'/#!user-'.$item->id; ?>";
