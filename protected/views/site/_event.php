...
<strong><?php
	...
	?></strong>
<span><i>Мастер:</i><?php echo empty($event->user->url) ? CHtml::link($event->user->name, '/site/axMasterInfo', array('data-toggle'=>'modal', 'data-target'=>'#modal')) : CHtml::link($event->user->name, $event->user->url); ?></span>
