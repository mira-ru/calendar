...
var arrowsUpDown = {
	...
	showArrows:function () {
		...
		if ($("tr.selected").size() == 1) {
			$("<div class=\"adminArrows\"><div class=\"up btn btn-sm btn-success\">выше</div> <div style=\"height:3px\"></div> <div class=\"down btn btn-sm btn-danger\">ниже</div></div>").appendTo("body");
		}
	},
	/**
	...
	_initClick:function () {
		self = this;
		$('body').on('click', '.adminArrows .up, .adminArrows .down', function () {
